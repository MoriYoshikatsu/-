<x-guest-layout>
	...
	<div class="px-auto">
		<form action="/parameters/input" method="POST">
			...
			<!-- 移動可能時間の選択 -->
			<div class="trip_time">
				<label for="trip_time">片道の移動に使える時間を選択:</label>
			...
			<div class="spot_category">
				<label for="spot_category">行きたい場所のカテゴリーを選択:</label>
				<select name="parameter[spot_category_id]">
			...
			<input type="submit" value="このスキマ時間で出かける！"/>
		</form>
	</div>
	<script>
		let map;
